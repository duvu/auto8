                  ...
                  {jobs.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="border px-3 py-8 text-center">
                        <p className="text-sm font-medium text-ink mb-1">No background jobs yet</p>
                        <p className="text-xs text-muted">Jobs are created automatically when RFQs are processed, attachments are parsed, or catalogue embeddings are generated.</p>
                      </td>
                    </tr>
                  ) : (
                    jobs.map((j) => (
